        ...
        <div class="auth-card">
            ...
            <div id="formState">
                ...
                <div class="auth-info-text">
                    ...
                    Chúng tôi sẽ gửi một liên kết đặt lại mật khẩu đến email đã đăng ký. Link có hiệu lực trong <strong>30 phút</strong>.
                </div>

                <form id="forgotForm" onsubmit="return false;">
                    <div class="mb-4">
                        <label class="form-label" for="email_or_username">Email hoặc tên đăng nhập</label>
                        <input name="email_or_username" class="form-control" type="text" id="email_or_username" placeholder="Nhập email hoặc tên đăng nhập" autocomplete="username" required>
                    </div>
                ...
                <div class="auth-link">
                    <a href="<?php echo BASE_URL; ?>auth/dangnhap.php"><i class="fas fa-arrow-left"></i> Quay lại đăng nhập</a>
                </div>
            </div>
            ...
            <div class="success-state" id="successState">
                ...
                <a href="<?php echo BASE_URL; ?>auth/dangnhap.php" class="btn-auth" style="display:inline-block; text-decoration:none; width:auto; padding:12px 32px;">
