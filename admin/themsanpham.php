...
//
        ...
        $sql_query
            = "INSERT INTO tbl_qlsanpham(tensp,anhgiuoithieu1,anhgiuoithieu2,anhdaidien,giasanpham,giagoc,noidung,ngaytao,nhomsp) VALUES('$tensp','$anhgiuoithieu1','$anhgiuoithieu2','$anhdaidien','$giasanpham','$giagoc','$noidung','"
            .time()."','$nhomsp')";
    ...
    <div class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
        ...
        <div class="bg-gray-800 pt-3">
            <div class="rounded-tl-3xl bg-gradient-to-r from-blue-900 to-gray-800 p-4 shadow text-2xl text-white">
                <h3 class="font-bold pl-2">Thêm sản phẩm</h3>
            </div>
        </div>
            ...
            <div class="w-1/2 m-auto ">
                <form enctype="multipart/form-data" method="post"
                    ...
                    <label class="block">
                        ...
                        <input type="price" name="giasanpham"
                               class="form-input border-2  border-blue-400 rounded-lg mt-1 block w-full"
                               placeholder="">
                    </label>
                    <label class="block">
                        <span class="text-gray-700">Giá gốc(đơn vị VND):</span>
                        <input type="price" name="giagoc"
                               class="form-input border-2  border-blue-400 rounded-lg mt-1 block w-full"
                               placeholder="">
                    </label>
                    <label class="block">
