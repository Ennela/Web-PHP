...
<?php
    ...
    // Lấy số lượng đã bán từ oder_chitiet
    $sold_query = mysqli_query($con, "SELECT masp, SUM(quantity) as sold FROM `oder_chitiet` GROUP BY masp");
    $soldMap = [];
    if ($sold_query) {
...
<head>
    ...
    <!-- Premium styles now loaded from css/test.css -->
</head>
                ...
                <li class="flex-1 md:flex-none md:mr-3">
                    <div class="inline-block relative">
                        <button class="text-white drop-button focus:outline-none"
                                ...
                                echo 'Xin chào, ' . $_SESSION['dangnhap1'] ?>
...
<div class="flex flex-col md:flex-row">
    ...
    <div class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
        ...
        <div class="bg-gray-800 pt-3">
            <div class="page-hero shadow text-2xl text-white">
                <h3 class="font-bold pl-2"><i class="fas fa-dolly mr-2"></i> Danh sách sản phẩm</h3>
            </div>
        </div>
        ...
        <div class="flex flex-wrap">
            <div class="w-full p-6">
                <!--Metric Card-->
                <div class="metric-card p-5 animate-in">
                    <div class="flex flex-row items-center">
                        <div class="flex-shrink pr-4">
                            <div class="metric-icon"><i
                                        class="fas fa-dolly fa-lg" style="color:#fff;"></i>
                            </div>
                        </div>
                        <div class="flex-1 text-right md:text-center">
                            <h5 class="font-bold uppercase" style="color:#64748b; font-size:0.82rem; letter-spacing:0.5px;">Tổng sản phẩm</h5>
                            <h3 class="font-bold text-3xl" style="color:#1e293b;"><?= $totalRecords ?> <span style="font-size:1rem;color:#64748b;">sản phẩm</span></h3>
                        </div>
                    </div>
                </div>
                <!--/Metric Card-->
            </div>
            <div class="w-full px-6 pb-4 flex flex-row-reverse">
                ...
                <!--                </button>-->
                <button class="btn-add ml-4">
                    <a href="./themsanpham.php"><i class="fas fa-plus mr-1"></i> Thêm sản phẩm</a>
                </button>
                <div class="search-bar flex-1 animate-in" style="animation-delay: 0.1s;">
                    <form action="quanlisanpham.php?action=search" method="POST" class="flex items-center gap-2 flex-wrap w-full">
                            <input type="text"
                                   placeholder="Mã sản phẩm ..." name="masp"
            ...
            <div class="flex w-full px-6 pb-2 justify-end">
                <div class="records-info"><i class="fas fa-info-circle" style="color:#3b82f6;"></i> Có tất cả <strong><?= $totalRecords ?></strong> sản phẩm trên <strong><?= $totalPages ?></strong> trang</div>
            </div>
            <div class="w-full p-6">
              <div class="table-wrapper animate-in" style="animation-delay: 0.2s;">
                <table id="table_customers">
                    ...
                    <tr>
                        ...
                        <th class="w-2/12 ">Tên sản phẩm</th>
                        <th class="w-1/12 ">Giá bán (VND)</th>
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            <tr>
                                ...
                                <td><img height="100"
                                         ...
                                         width="100"/></td>
                                <td><?= $row['tensp'] ?></td>
                                <td class="text-center" style="color:#2563eb; font-weight:700;"><?= number_format($row['giasanpham'], 0, ",", ".") ?></td>
