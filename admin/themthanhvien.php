                ...
                <div class="w-1/2 m-auto ">
                    <form method="post" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                        <label class="block ">
                            ...
                            <input name="hoten"
                                class="form-input border-2  border-blue-400 rounded-lg mt-1 block w-full" placeholder=""
                                type="text">
                        </label>
                        <!--giới tính-->
                        <label class="block mt-2">
                            ...
                            <div class="mt-2">
                                <label class="inline-flex items-center">
                                    <input class="form-radio" name="gioitinh" type="radio" value="0">
                                    <span class="ml-2">Nam</span>
                                </label>
                                <label class="inline-flex items-center ml-6">
                                    <input class="form-radio" name="gioitinh" type="radio" value="1">
                        ...
                        <label class="block mt-2">
                            ...
                            <input type="text" name="diachicuthe"
                        ...
                        <label class="block mt-2">
                            ...
                            <textarea type="text" name="motacongviec"
