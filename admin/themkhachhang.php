    ...
    <div class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
        ...
        <div class="bg-gray-800 pt-3">
            <div class="rounded-tl-3xl bg-gradient-to-r from-blue-900 to-gray-800 p-4 shadow text-2xl text-white">
                <h3 class="font-bold pl-2">Thêm khách hàng</h3>
            </div>
        </div>
                ...
                <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    ...
                    <label class="block mt-2">
                        ...
                        <div class="mt-2">
                            <label class="inline-flex items-center">
                                <input class="form-radio" name="accountType" type="radio" value="personal">
                                <span class="ml-2">Nam</span>
                            </label>
                            <label class="inline-flex items-center ml-6">
                                <input class="form-radio" name="accountType" type="radio" value="busines">
                    ...
                    <label class="flex mt-2">
                        <div class="w-1/3 p-1">
                            ...
                            <span class="text-gray-700">Tỉnh:</span>
                            <select class="form-input border-2  border-blue-400 rounded-lg mt-1 block w-full">
                        ...
                        <div class="w-1/3 p-1">
                            <span class="text-gray-700">Phường/xã:</span>
                            <select class="form-input border-2  border-blue-400 rounded-lg mt-1 block w-full">
                                <option>P.Hà Huy Tập</option>
                                <option>Missouri</option>
                                <option>Texas</option>
                            </select>
                        </div>
                    ...
                    <label class="block mt-2">
                        ...
                        <textarea class="form-textarea border-2 rounded-lg border-blue-400  mt-1 block w-full"
                                  placeholder=""
                                  rows="3"></textarea>
                    </label>
