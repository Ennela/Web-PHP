        ...
        <div class="carousel slide" data-bs-ride="carousel" id="carousel-hero"
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100 d-block hero-img" src="<?php echo BASE_URL; ?>images/632663.jpg"
                        alt="Nike LeBron 7">
                    <div class="carousel-caption d-none d-md-block modern-caption">
                        ...
                        <a href="<?php echo BASE_URL; ?>shop/chitietsanpham.php?masp=80" class="modern-btn mt-3">Khám
                            phá ngay</a>
                    </div>
                </div>
                <div class="carousel-item">
                    <img class="w-100 d-block hero-img"
                        src="<?php echo BASE_URL; ?>images/Jordan-1-Light-Smoke-Gray-min.jpg"
                    ...
                    <div class="carousel-caption d-none d-md-block modern-caption">
                        ...
                        <a href="<?php echo BASE_URL; ?>shop/chitietsanpham.php?masp=83" class="modern-btn mt-3">Khám
                            phá ngay</a>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-none d-md-block modern-caption">
                        ...
                        <a href="<?php echo BASE_URL; ?>shop/chitietsanpham.php?masp=67" class="modern-btn mt-3">Khám
                            phá ngay</a>
                    </div>
                </div>
            </div>
    ...
    <section class="clean-block editorial-section">
        <div class="container">
            <div class="text-center">
                ...
                <p class="editorial-subheading">Thể hiện cá tính dứt khoát và nhịp đập bùng nổ của tuổi trẻ qua từng
                    bước chân.</p>
            </div>
            <div class="row align-items-center mt-5">
                <div class="col-md-6 mb-5 mb-md-0">
                    <img class="img-fluid img-editorial"
                        src="<?php echo BASE_URL; ?>admin/uploads/jordan_paris_banner.png" alt="Air Jordan 1 Low Paris">
                </div>
                <div class="col-md-6 ps-md-5">
                    <h3 class="product-highlight-title">AIR JORDAN 1 LOW 'PARIS'</h3>
                    <div class="getting-started-info">
                        <p class="product-highlight-text">Lấy cảm hứng từ kinh đô ánh sáng, phiên bản
                            <strong>'Paris'</strong> mang đến vẻ đẹp thanh lịch vượt thời gian. Màn phối màu hoàn hảo
                            giữa sắc trắng tinh khôi, xám nhạt và xanh pastel dịu mắt tạo nên sự hài hòa đẳng cấp.
                        </p>
                        <p class="product-highlight-text">Lớp da lộn cao cấp kết hợp với da trơn siêu mịn mang lại cảm
                            giác sang trọng. Điểm nhấn chói sáng nằm ở logo Jumpman được dập nổi mạ vàng kiêu hãnh trên
                            lưỡi gà. Không chỉ là một đôi giày, đây là mảnh ghép hoàn hảo xác định đẳng cấp outfit của
                            bạn.</p>
                    </div>
                    <a href="<?php echo BASE_URL; ?>shop/chitietsanpham.php?masp=79" class="btn-editorial mt-2">SỞ HỮU
                        NGAY</a>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-3 mb-4">
                    <div class="feature-box">
                        ...
                        <p class="feature-desc">Vận chuyển tốc hành, an toàn. Đảm bảo đến tận tay bạn dù ở bất cứ đâu
                            tại Việt Nam.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 mb-4">
                    <div class="feature-box">
                        ...
                        <p class="feature-desc">Nhận hàng, kiểm tra kỹ lưỡng sản phẩm trực tiếp rồi mới phải thanh toán.
                        </p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 mb-4">
                    <div class="feature-box">
                        ...
                        <p class="feature-desc">Cam kết bảo hành lên đên 60 ngày cho các chi tiết về keo dán và đường
                            chỉ.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 mb-4">
                    <div class="feature-box">
                        ...
                        <p class="feature-desc">Sẵn sàng hỗ trợ đổi size, đổi mẫu cực kỳ thoải mái và linh hoạt trong
                            vòng 30 ngày.</p>
                    </div>
                </div>
            </div>
    ...
    <section class="bestseller-section">
        <div class="container">
                        ...
                        <div class="card product-card h-100">
                            <div class="pc-img-wrap">
                                <a href="<?php echo BASE_URL; ?>shop/chitietsanpham.php?masp=<?= $row['masp'] ?>">
                                    <img class="card-img-top" src="<?php echo BASE_URL; ?>admin/<?= $row['anhdaidien'] ?>"
                                        alt="<?= $row['tensp'] ?>" style="height: 380px; object-fit: cover; width: 100%;">
                                </a>
                            </div>
                            <div class="card-body text-center d-flex flex-column" style="padding: 25px;">
                                <h5 class="card-title"
                                    style="font-weight: 800; font-size: 1.15rem; color: #1e293b; margin-bottom: 15px;">
                                    <?= $row['tensp'] ?>
                                </h5>
                                ...
                                <div class="mt-auto">
                                    <a href="<?php echo BASE_URL; ?>shop/chitietsanpham.php?masp=<?= $row['masp'] ?>"
                                        class="btn-editorial-outline">XEM CHI TIẾT</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="text-center mt-5">
                <a href="<?php echo BASE_URL; ?>shop/shop.php" class="btn-editorial-outline"
                    style="padding: 14px 40px; font-size: 1.1rem; border-width: 2px;">XEM TẤT CẢ SẢN PHẨM &rarr;</a>
            </div>
        </div>
    </section>
    ...
    <section class="team-section">
        <div class="container">
            <div class="block-heading text-center mb-5">
                <h2 class="font-weight-bold text-uppercase" style="color: #1e293b; letter-spacing: 1.5px;">Đội ngũ của
                    chúng tôi</h2>
                    ...
                    <div class="card team-member">
                        ...
                        <div class="team-info">
                            ...
                            <div class="social-icons">
                                <a href="https://www.facebook.com/nguyenkien.sora"><i
                ...
                <div class="col-sm-6 col-lg-4 mb-4">
                    <div class="card team-member">
                        ...
                        <div class="team-info">
                            ...
                            <p>BRAND MANAGER</p>
                            <div class="social-icons">
                                <a href="https://www.facebook.com/oquangha.840034"><i
                                        class="icon-social-facebook"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-6 col-lg-4 mb-4">
                    <div class="card team-member">
                        ...
                        <div class="team-info">
                            ...
                            <div class="social-icons">
                                <a href="https://www.facebook.com/nhan.ba.494017"><i
                                        class="icon-social-facebook"></i></a>
                            </div>
                        </div>
                    </div>
